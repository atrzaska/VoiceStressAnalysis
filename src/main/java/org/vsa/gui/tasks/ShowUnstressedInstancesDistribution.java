 ...
 */
public class ShowUnstressedInstancesDistribution extends SwingWorker<Void,Void> {
     ...
     * @param window 
     */
    public ShowUnstressedInstancesDistribution(MainWindow window) {
        this.window = window;
    }
    ...
    protected Void doInBackground() throws Exception {
        ...
        try {
            ...
            PlotUtil.drawNormalDistribution(window, experiment.getUnstressedMean(), experiment.getUnstressedStd());
        } catch(Exception e) {

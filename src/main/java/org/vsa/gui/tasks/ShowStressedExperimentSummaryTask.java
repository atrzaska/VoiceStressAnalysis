 ...
 * ShowSummaryTask
 */
public class ShowStressedExperimentSummaryTask extends SwingWorker<Void,Void> {
     ...
     * @param window 
     */
    public ShowStressedExperimentSummaryTask(MainWindow window) {
        this.window = window;
    }
    ...
    protected Void doInBackground() throws Exception {
        ...
        try {
            ...
            // set text
            summaryWindow.setTextSummary(experiment.getStressedSummaryString());

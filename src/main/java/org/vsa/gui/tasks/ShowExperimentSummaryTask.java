...
/**
 * ShowExperimentSummaryTask
 */
public class ShowExperimentSummaryTask extends SwingWorker<Void,Void> {
     ...
     * @param window 
     */
    public ShowExperimentSummaryTask(MainWindow window) {
        this.window = window;
    }
    ...
    protected Void doInBackground() throws Exception {
        ...
        try {
            ...
            // set text
            summaryWindow.setTextSummary(experiment.toSummaryString());
